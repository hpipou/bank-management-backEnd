package io.bank.management.jwt;
...
public class JwtAuthentification extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) throws IOException, ServletException {
        ...
        String jwtAccessToken= JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis()+Variables.EXPIREACCESSTOKEN))
        ...
        String jwtRefreshToken= JWT.create()
                .withSubject(username)
                .withIssuer(request.getRequestURL().toString())
                .withExpiresAt(new Date(System.currentTimeMillis()+Variables.EXPIREREFRESHTOKEN))
                .sign(algorithm);
